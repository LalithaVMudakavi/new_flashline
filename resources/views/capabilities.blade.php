...
<section class="section section-alt" id="capabilities">
  ...
  <div class="spec-grid">
    ...
    <div class="spec-card reveal">
      ...
      <dl>
        ...
        <div><dt>Largest component</dt><dd>100 × 100 mm, height ≤ 25.4 mm</dd></div>
        <div><dt>Chip accuracy</dt><dd>±50 µm</dd></div>
        <div><dt>IC accuracy</dt><dd>±30 µm</dd></div>
        <div><dt>BGA range</dt><dd>0.15 mm ball → 100 × 100 mm</dd></div>
      </dl>
    </div>
    ...
    <div class="spec-card reveal">
      ...
      <dl>
        ...
        <div><dt>Maximum PCB</dt><dd>510 × 510 mm</dd></div>
        <div><dt>Board Thickness</dt><dd>0.1mm-6mm supported</dd></div>
        <div><dt>Fabrication</dt><dd>HDI to 60 layers, rigid-flex, metal-core, Hybrid Material </dd></div>
      </dl>
    </div>
    ...
    <div class="spec-card reveal">
      ...
      <dl>
        <div><dt>SMT lines</dt><dd>2 × Fuji Aimex IIIC (automated)</dd></div>
        <div><dt>Inspection</dt><dd>Koh Young 3D Zenith Alpha HS+ 3D AOI & SPI</dd></div>
        <div><dt>Reflow</dt><dd>Nitrogen-capable oven</dd></div>
        <div><dt>Feeder capacity</dt><dd>444 feeders + 10 tray positions</dd></div>
      </dl>
    </div>
  ...
  <div class="stackup reveal" role="img" aria-label="Cross-section diagram of a 60-layer HDI PCB stack-up">
    ...
    <svg viewBox="0 0 960 216" aria-hidden="true">
      ...
      <rect x="70" y="88" width="820" height="38"
            fill="none"
            stroke="var(--line)"
      ...
      <path d="M193 23 L207 23 L203 51 L197 51 Z"
            fill="var(--copper-2)"/>

      <rect x="465" y="69" width="10" height="76"
            fill="var(--copper-2)"/>

      <rect x="459" y="66" width="22" height="5"
            fill="var(--copper-2)"/>

      <rect x="459" y="143" width="22" height="5"
            fill="var(--copper-2)"/>

      <rect x="725" y="23" width="12" height="173"
            fill="var(--copper-2)"
            opacity=".9"/>

      <rect x="718" y="20" width="26" height="6"
            fill="var(--copper-2)"/>

      <rect x="718" y="193" width="26" height="6"
            fill="var(--copper-2)"/>

      <g fill="var(--muted)" font-size="10.5">
        <text x="216" y="14">
          μVIA L1→L2 · LASER ⌀0.10 MM
        </text>
